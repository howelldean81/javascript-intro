...
// Array.includes()
// Determines thether an array has a specific element
let shoppingList = ['celery', 'limes', 'lemons', 'salt', 'oranges'];
...
// Array.every()
// Checks is all elements in an array pass a test given as a function. If there is 1 element that returns a false value, the function returns flase and does not check the rest of the elements.
let shoppingList = ['celery', 'limes', 'lemons', 'salt', 'oranges'];
...
// Array.splice()
// Add/removes the elements in an array and returns the removed elements. First argument takes in an integer that specifies at what index to add/remove the elements. Second argument takes in the number of items to be removed. Optional third argument takes in the new elements to be added to the array.
let shoppingList = ['celery', 'limes', 'lemons', 'salt', 'oranges'];
shoppingList.splice(2,1,'cherries');
console.log(shoppingList);

// Array,sort()
// Sorts the items in an array, The sort order can either be alphabetic or numeric, and either ascending or descending. By default the sort() orders the values as strings in alphabetic and ascending order. Can take in a compare function which indicates if you want to sort be ascending or descending values.
let shoppingList = ['celery', 'limes', 'lemons', 'salt', 'oranges'];
...
// Array.join()
// Converts the elements of an array into a String. Can accept an optional parameter. "Seperator", which indicates how the elements will be seperated. Default seperator is a comma.
let shoppingList = ['celery', 'limes', 'lemons', 'salt', 'oranges'];
